...
import pandas as pd 
import pickle 
from modelling import RandomForest as rf  # Assuming RandomForest model is implemented in 'RandomForest.py'

st.title('Death Prediction using Random Forest')
...
# Load the trained Random Forest model and output data
model_file_path = 'random_forest_model.pickle'
output_file_path = 'random_forest_output.pickle'
random_forest_model, uniques = load_model_and_output(model_file_path, output_file_path)
...
if not filtered_data.empty:
    ...
    predictions = random_forest_model.predict(filtered_data)
